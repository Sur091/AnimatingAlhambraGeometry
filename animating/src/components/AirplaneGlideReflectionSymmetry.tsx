...
const timeBeforeReflection = tessellationVectors.length * 0.3 + drawDuration + 2;
...
const AirplaneGlideReflectionalSymmetry: React.FC = () => {
    ...
    >
      {startAnimation && (
        ...
        >
          ...
          <motion.path
            d={`M ${-R} -250 L ${-R} 250`} // Your SVG Path
            stroke="#3b82f6"
            strokeWidth="2"
...
export default AirplaneGlideReflectionalSymmetry;
